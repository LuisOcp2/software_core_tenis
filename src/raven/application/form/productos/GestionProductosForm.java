...
public class GestionProductosForm extends javax.swing.JPanel {
    ...
    private void buildPaginationPanel() {
        paginationPanel = new javax.swing.JPanel(new java.awt.FlowLayout(java.awt.FlowLayout.RIGHT, 8, 6));

        // Helper para cargar iconos de forma segura
        java.util.function.Function<String, javax.swing.Icon> loadIcon = path -> {
            try {
                return new com.formdev.flatlaf.extras.FlatSVGIcon(path, 0.5f);
            } catch (Exception e) {
        ...
        // Asegurar tamaño mínimo para clicabilidad y estilo visible
        java.awt.Dimension btnSize = new java.awt.Dimension(44, 36);
        ...
        // Estilos FlatLaf para botones (colores más visibles)
        String baseStyleBlue = "arc:18; borderWidth:1; borderColor:darken(#0A84FF,10%); background:#0A84FF; foreground:#ffffff;";
        String baseStyleGray = "arc:18; borderWidth:1; borderColor:darken(#8892a6,10%); background:#8892a6; foreground:#ffffff;";
        ...
        lblPageInfo.putClientProperty(com.formdev.flatlaf.FlatClientProperties.STYLE, "font:bold; foreground:#e6eaf2;");
        txtGoToPage = new javax.swing.JTextField(3);
        cbxPageSize = new javax.swing.JComboBox<>(new String[] { "10", "25", "50" });
        lblPageSize = new javax.swing.JLabel("Por página:");

        paginationPanel.add(btnFirstPage);
        paginationPanel.add(btnPreviousPage);
        paginationPanel.add(lblPageInfo); // Info en medio
        ...
        paginationPanel.add(javax.swing.Box.createHorizontalStrut(10));

        paginationPanel.add(lblPageSize);
        paginationPanel.add(cbxPageSize);

        this.setLayout(new java.awt.BorderLayout());
        java.awt.Component main = panel;
        this.removeAll();
        this.add(lb, java.awt.BorderLayout.NORTH);
        this.add(main, java.awt.BorderLayout.CENTER);
        this.add(paginationPanel, java.awt.BorderLayout.SOUTH);
    ...
    private void showLoading(String text) {
        ...
        // MODIFICADO: Eliminado el overlay bloqueante y la ventana emergente.
        // Solo indicamos carga en el cursor y la etiqueta de estado.
    ...
    /**
     * Actualiza la UI según la ubicación del usuario
     */
    private void updateUIForUserLocation() {
        ...
        try {
            ...
            if (idBodega != null && idBodega > 0) {
                ...
                LbBodega.setText((b != null ? b.getNombre() : ("Bodega #" + idBodega)) + " • Pares: " + totalPares);
            } else {
    ...
    /**
     * Configura los estilos del panel principal
     */
    private void setupPanelStyles() {
        ...
        txtSearch.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Buscar productos...");
    ...
    private void setupTableStyles() {
        table.getTableHeader().putClientProperty(FlatClientProperties.STYLE,
                "height:30;hoverBackground:null;pressedBackground:null;separatorColor:$Login.background;font:bold;");

        table.putClientProperty(FlatClientProperties.STYLE,
                "rowHeight:70;showHorizontalLines:true;intercellSpacing:0,1;cellFocusColor:$Accent.yellow;" +
                        "selectionBackground:$Accent.yellow;selectionForeground:$Table.foreground;background:$Login.background;");
    ...
    private void setupButtonStyles() {
        ...
        // Colores específicos
        btn_editar.putClientProperty(FlatClientProperties.STYLE, "background:$Accent.yellow");
        btn_eliminar.putClientProperty(FlatClientProperties.STYLE, "background:$App.accent.red");

        // Colores para Productos, Variantes y Precios
        btn_Prducto.putClientProperty(FlatClientProperties.STYLE,
                "background:#2196F3;foreground:#FFFFFF;font:bold 12"); // Azul
        btn_Variable.putClientProperty(FlatClientProperties.STYLE,
                "background:#9C27B0;foreground:#FFFFFF;font:bold 12"); // Púrpura
        btn_Precios.putClientProperty(FlatClientProperties.STYLE,
                "background:#FF9800;foreground:#FFFFFF;font:bold 12"); // Naranja
        btn_SinPrecioVenta.putClientProperty(FlatClientProperties.STYLE,
                "background:#E53935;foreground:#FFFFFF;font:bold 12");

        // Color para Cargar Caja
        btnCargarPorCaja.putClientProperty(FlatClientProperties.STYLE,
                "background:#4CAF50;foreground:#FFFFFF;font:bold 12"); // Verde

        // Estilos para botones de paginación
        String paginationStyle = "arc:10;borderWidth:0;focusWidth:0;innerFocusWidth:0;background:$Panel.background;hoverBackground:$Button.backgroundPressed";
        ...
        try {
            ...
            FlatSVGIcon caja = (cajaUrl != null)
                    ? new FlatSVGIcon(cajaUrl).derive(16, 16)
                    : new FlatSVGIcon("raven/icon/svg/caja.svg").derive(16, 16);
            ...
            FlatSVGIcon iconProducto = new FlatSVGIcon("raven/icon/svg/caja.svg", 16, 16);
            FlatSVGIcon iconVariante = new FlatSVGIcon("raven/icon/icons/imagen.svg", 16, 16);
            FlatSVGIcon iconPrecios = new FlatSVGIcon("raven/icon/icons/usd-circulo.svg", 16, 16);
            FlatSVGIcon iconSinPrecio = new FlatSVGIcon("raven/icon/icons/circulo-cruzado.svg", 16, 16);
            ...
            btnCargarPorCaja.setIconTextGap(6);
            btn_Prducto.setIconTextGap(6);
            btn_Variable.setIconTextGap(6);
            btn_Precios.setIconTextGap(6);
            btn_SinPrecioVenta.setIconTextGap(6);
        } catch (Exception e) {
    ...
    private void openEditModal(ModelProduct product) {
        try {
            ...
            // Pasamos el producto directamente, ya tiene IDs y nombres
            editForm.cargarDatosProducto(service, product);
    ...
    private void btn_VariableActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btn_VariableActionPerformed
        ...
        openVariantModalForProduct(selectedProducts.get(0), null);
    ...
    public void openVariantModalForProduct(ModelProduct product, Integer variantId) {
        ...
        cbProveedor.putClientProperty(FlatClientProperties.STYLE, "arc:24;background:lighten($Menu.background,25%)");
        ...
        cbTipo.putClientProperty(FlatClientProperties.STYLE, "arc:24;background:lighten($Menu.background,25%)");

        javax.swing.JLabel lblColor = new javax.swing.JLabel("Color");
        javax.swing.JComboBox<IdName> cbColor = new javax.swing.JComboBox<>();
        cbColor.putClientProperty(FlatClientProperties.STYLE, "arc:24;background:lighten($Menu.background,25%)");

        javax.swing.JLabel lblTalla = new javax.swing.JLabel("Talla");
        javax.swing.JComboBox<IdName> cbTalla = new javax.swing.JComboBox<>();
        cbTalla.putClientProperty(FlatClientProperties.STYLE, "arc:24;background:lighten($Menu.background,25%)");
        ...
        txtStock.putClientProperty(FlatClientProperties.STYLE, "arc:24;background:lighten($Menu.background,25%)");
        ...
        cbBodega.putClientProperty(FlatClientProperties.STYLE, "arc:24;background:lighten($Menu.background,25%)");
        ...
        btnImagen.putClientProperty(FlatClientProperties.STYLE, "arc:24;background:#0A84FF;foreground:#fff");
        ...
        imgPreview.putClientProperty(FlatClientProperties.STYLE,
                "arc:24;borderColor:darken($Component.borderColor,10%);background:lighten($Menu.background,15%);padding:6,6,6,6");
        ...
        txtEst.putClientProperty(FlatClientProperties.STYLE, "arc:24;background:lighten($Menu.background,25%)");
        ...
        txtPrecioCompra.putClientProperty(FlatClientProperties.STYLE,
                "arc:24;background:lighten($Menu.background,25%)");
        ...
        txtPrecioVenta.putClientProperty(FlatClientProperties.STYLE, "arc:24;background:lighten($Menu.background,25%)");
    ...
    public void openVariantModalForProduct(ModelProduct product, Integer variantId, String initialType,
        ...
        imgPreview.setPreferredSize(new java.awt.Dimension(160, 120));
        imgPreview.putClientProperty(FlatClientProperties.STYLE,
                "arc:24;background:lighten($Menu.background,15%);border:5,5,5,5");
        btnImagen.addActionListener(e -> {
            try {
                java.awt.FileDialog fd = new java.awt.FileDialog(
                        (java.awt.Frame) javax.swing.SwingUtilities.getWindowAncestor(this), "Seleccionar Imagen",
    ...
    private List<ModelProduct> getSelectedData() {
        ...
        for (int i = 0; i < table.getRowCount(); i++) {
            ...
            if ((boolean) table.getValueAt(i, 0)) {
                ...
                ModelProduct data = (ModelProduct) table.getValueAt(i, 2);
                list.add(data);
            }
        }
