...
import raven.application.form.productos.creates.CreateBrand;
...
public class MarcasForm extends javax.swing.JPanel {
    // Instancia del servicio para operaciones con empleados

    private final ServiceBrand service = new ServiceBrand();
    ...
    private void loadData() throws SQLException {
        try {
            ...
            List<ModelBrand> list = service.getAll();

            // Añade cada empleado como fila en la tabla
            for (ModelBrand d : list) {
    ...
    private void searchData(String search) throws SQLException {
        ...
        List<ModelBrand> list = service.search(search);
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_txtSearchKeyReleased
        try {
            ...
            Logger.getLogger(MarcasForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    }// GEN-LAST:event_txtSearchKeyReleased

    private void btn_nuevoActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btn_nuevoActionPerformed
        CreateBrand cr = new CreateBrand();
        ...
        SimpleModalBorder border = new SimpleModalBorder(cr, "Nueva marca", options, (ModalController mc, int i) -> {
            if (i == SimpleModalBorder.OK_OPTION) {
                ...
                runModalActionWithButtonLoading(
                        ...
                        () -> {
                            Toast.show(MarcasForm.this, Toast.Type.SUCCESS, "Marca creada exitosamente");
                            try {
                                loadData();
                            } catch (SQLException ex) {
                                Toast.show(MarcasForm.this, Toast.Type.ERROR,
                        ...
                        (ex) -> {
                            ...
                            Toast.show(MarcasForm.this, Toast.Type.ERROR, "Error: " + cause.getMessage());
                        });
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btn_eliminarActionPerformed
        List<ModelBrand> list = getSelectedData();
        if (!list.isEmpty()) {
            SimpleModalBorder.Option[] options = new SimpleModalBorder.Option[] {
                    new SimpleModalBorder.Option("Cancelar", SimpleModalBorder.CANCEL_OPTION),
                            ...
                            (mc, i) -> {
                                if (i == SimpleModalBorder.OK_OPTION) {
                                    ...
                                    runModalActionWithButtonLoading(
                                            ...
                                            () -> {
                                                Toast.show(this, Toast.Type.SUCCESS, "Marca(s) eliminada(s)");
                                                try {
                                                    loadData();
                                                } catch (SQLException ex) {
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btn_editarActionPerformed
        ...
        if (!list.isEmpty()) {
            if (list.size() == 1) {
                ModelBrand data = list.get(0);
                CreateBrand createB = new CreateBrand();
                createB.loadData(service, data);
                ...
                ModalDialog.showModal(this, // Componente padre (probablemente un JFrame o JPanel)
                        new SimpleModalBorder(
                                createB, // Panel de contenido (el formulario de edición)
                                "Editar Marca: " + data.getName(), // Título del diálogo
                                ...
                                (mc, i) -> {
                                    if (i == SimpleModalBorder.OK_OPTION) {
                                        ...
                                        runModalActionWithButtonLoading(
                                                ...
                                                () -> {
                                                    try {
                                                        ModelBrand dataEdit = createB.getData();
                                                        dataEdit.setBrandId(data.getBrandId());
                                                ...
                                                () -> {
                                                    Toast.show(this, Toast.Type.SUCCESS, "Marca actualizada");
                                                    try {
                                                        loadData();
                                                    } catch (SQLException ex) {
                                                        Toast.show(this, Toast.Type.ERROR,
                                        ...
                                        createB.init();
                                        Window w = SwingUtilities.getWindowAncestor(createB);
    ...
    private List<ModelBrand> getSelectedData() {

        // Crea una nueva lista vacía para almacenar los productos seleccionados
        List<ModelBrand> list = new ArrayList<>();
        ...
        for (int i = 0; i < table.getRowCount(); i++) {
            ...
            if ((boolean) table.getValueAt(i, 0)) {
                ...
                // actual
                ModelBrand data = (ModelBrand) table.getValueAt(i, 2);
                list.add(data);
            }
        }
