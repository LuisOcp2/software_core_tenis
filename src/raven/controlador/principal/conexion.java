...
public class conexion {
  ...
  // public static final String password = "";
    ...
    try {
        ...
        dataSource.setInitialSize(2);          // Menos conexiones iniciales para reducir overhead
        dataSource.setMaxTotal(8);             // Menos conexiones máximas para evitar congestión
        dataSource.setMaxIdle(4);              // Conexiones máximas inactivas
        dataSource.setMinIdle(2);              // Mínimo de conexiones siempre disponibles
        dataSource.setMaxWaitMillis(15000);    // Mayor espera para obtener conexión
