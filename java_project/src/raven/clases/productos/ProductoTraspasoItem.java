...
public class ProductoTraspasoItem {
     ...
     */
    public ProductoTraspasoItem clonar() {
        ProductoTraspasoItem clon = new ProductoTraspasoItem();
    ...
    public boolean equals(Object obj) {
        ...
        ProductoTraspasoItem that = (ProductoTraspasoItem) obj;

        if (!idProducto.equals(that.idProducto))
            return false;
        if (idVariante != null ? !idVariante.equals(that.idVariante) : that.idVariante != null)
            return false;
