            ...
            if (dark) {
                EventQueue.invokeLater(() -> {
                    ...
                    try {
                        ...
                        Notifications.getInstance().show(Notifications.Type.INFO, "Tema oscuro activado");
                    } catch (Exception ex) {
                        Notifications.getInstance().show(Notifications.Type.WARNING,
                                "No se pudo guardar preferencia de tema");
                    }
                });
            } else {
                EventQueue.invokeLater(() -> {
                    ...
                    try {
                        ...
                        Notifications.getInstance().show(Notifications.Type.INFO, "Tema claro activado");
                    } catch (Exception ex) {
                        Notifications.getInstance().show(Notifications.Type.WARNING,
                                "No se pudo guardar preferencia de tema");
                    }
