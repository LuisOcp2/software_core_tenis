...
public class ModelProductVariant {
    ...
    public ModelProductVariant(int id, int productId, String talla, String color, String proveedor, int stock,
            String unidad, String bodega, Icon icon, File path, int bodegaId) {
        this.id = id;
        this.variantId = id;
    ...
    /**
     * Alias para getImageBytes por compatibilidad con versiones anteriores.
     * Retorna un arreglo de bytes (byte[]) con la información de la imagen.
     * 
     * @return byte[] de la imagen o null si no tiene.
     */
    ...
    /**
     * Alias para setImageBytes por compatibilidad con versiones anteriores.
     * 
     * @param imagen Arreglo de bytes de la imagen.
     */
    public void setImagen(byte[] imagen) {
        setImageBytes(imagen);
    }
