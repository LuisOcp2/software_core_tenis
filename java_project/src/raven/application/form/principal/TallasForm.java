 ...
 * @author CrisDEV
 */
public class TallasForm extends javax.swing.JPanel {
    ...
    public TallasForm(int idProducto, int idColor, String tipoVenta, TallasFormCallback callback) {
...
private class SpinnerEditor extends DefaultCellEditor {
    ...
    private void initComponents() {
        ...
        tablaTallas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SELECIONAR", "TALLA", "STOCK", "CANTIDAD"
            }
        ) {
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        // Cerrar la ventana contenedora de forma segura
