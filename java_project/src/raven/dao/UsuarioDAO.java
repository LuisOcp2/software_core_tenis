...
public class UsuarioDAO {
    ...
    /**
     * Obtiene los datos completos del usuario para la sesión.
     * 
     * @param idUsuario ID del usuario
     * @return ModelUser hidratado o null
     */
    public raven.controlador.admin.ModelUser obtenerUsuarioActual(int idUsuario) throws SQLException {
        String sql = "SELECT * FROM usuarios WHERE id_usuario = ?";
        Connection con = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        ...
        try {
            ...
            if (rs.next()) {
                raven.controlador.admin.ModelUser user = new raven.controlador.admin.ModelUser();
                user.setIdUsuario(rs.getInt("id_usuario"));
                user.setUsername(rs.getString("username"));
                user.setNombre(rs.getString("nombre"));
                user.setRol(rs.getString("rol"));
                user.setUbicacion(rs.getString("ubicacion"));
                user.setIdBodega((Integer) rs.getObject("id_bodega"));
