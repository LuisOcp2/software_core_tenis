...
--
-- Servidor: localhost
-- Tiempo de generación: 03-02-2026 a las 22:01:38
...
-- Update for Transfer Pricing
ALTER TABLE `traspasos` ADD COLUMN `monto_total` decimal(10,2) NOT NULL DEFAULT 0.00;
ALTER TABLE `traspasos` ADD COLUMN `monto_recibido` decimal(10,2) NOT NULL DEFAULT 0.00;
ALTER TABLE `traspaso_detalles` ADD COLUMN `precio_unitario` decimal(10,2) NOT NULL DEFAULT 0.00;
ALTER TABLE `traspaso_detalles` ADD COLUMN `subtotal` decimal(10,2) NOT NULL DEFAULT 0.00;
